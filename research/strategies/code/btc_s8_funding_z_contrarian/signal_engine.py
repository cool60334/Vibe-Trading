# yaml-hash: 5f9b4cdfa3f934627582ca26224dc1cec179741ecffa837ed165f3bc9f126e5a
import sys
...
class SignalEngine:
    ...
    def generate(self, data_map: dict) -> dict:
        ...
        # Entry signals
        entry_long = ((((funding_z.rolling(90*24, min_periods=90*24//2).rank(pct=True)*100 <= 20.0)).rolling(3).sum() >= 2))
        entry_short = ((((funding_z.rolling(90*24, min_periods=90*24//2).rank(pct=True)*100 >= 80.0)).rolling(3).sum() >= 2))
