"""Mid-freq ensemble (persistence 3/48) — between base 2/24 and lowfreq 4/72."""
...
TEMPLATE = ROOT / "runs" / "_templates" / "signal_engine_ensemble_mid.py"
REGIME_PARQUET = ROOT / "research" / "regime_labels.parquet"

RUNS = [
    ("ensemble_mid_bull",     "s2_baseline", "2024-05-14", "2026-05-13"),
    ("ensemble_mid_bear2022", "s2_bear",     "2021-11-08", "2022-12-31"),
    ("ensemble_mid_bear2018", "s2_bear2018", "2018-02-01", "2018-12-30"),
]
STRESS_MULT = 3.0
